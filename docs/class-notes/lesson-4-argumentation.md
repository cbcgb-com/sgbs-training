...
- [第一部分：課前預讀內容](#diyi-bufen-keqian-yudu-neirong)
    ...
    - [觀察篇章結構的工具：英文文法分析](#guancha-pianzhang-jiegou-de-gongju-yingwen-wenfa-fenxi)
...
> **回顧**：在[第一課：基礎](../lesson-1-foundations)中，我們學習了歸納式查經的基本方法。現在讓我們更深入地探討，如何將這四個步驟具體應用在論說文（如書信、講章、先知書的勸勉段落）中。
>
...
<div class="homework-item__content">
<p>請閱讀<a href="../lesson-5-situations">第五課</a>第一部分：課前預讀內容。</p>
</div>
</div>
